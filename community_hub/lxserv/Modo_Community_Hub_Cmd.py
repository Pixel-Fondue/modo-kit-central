# python
# ---------------------------------------
# Name:         Modo_Community_Hub_Cmd.py
# Version:      1.0
#
# Purpose:      This Command is designed to:
#               Open the QuickClips - Tutorial Videos using ID integer as argument to filter by Modo Releases defined in Menu.
#
...
# modo.Community.Hub 1510 true 1
...
class Modo_Community_Hub_Cmd(lxu.command.BasicCommand):
    ...
    def basic_Execute(self, msg, flags):
        ...
        ####### --> 15 . 1
        ### - Quick Clips
        if RELEASE_ID == 1510 and QC == True:
            if PAGE_ID == 1:
        ...
        ### - Tutorials
        if RELEASE_ID == 1510 and QC == False:
            if PAGE_ID == 1:
